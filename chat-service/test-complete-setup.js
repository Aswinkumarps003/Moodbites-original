// Complete test for chat service and dietician functionality
import fetch from 'node-fetch';

const testCompleteSetup = async () => {
  console.log('🧪 Testing Complete Chat Service & Dietician Setup...\n');
  ...
  try {
    ...
    // Test 2: Test conversations for dietician (FIXED)
    ...
    console.log('\n🎉 Complete setup test completed!');
    console.log('✅ Chat service is working with your MongoDB data');
    console.log('✅ Conversations API is now fixed');
    ...
    console.log('3. Login as dietician and test chat panel');
    console.log('4. Select patient and view messages');
    console.log('5. Send messages back to users');
